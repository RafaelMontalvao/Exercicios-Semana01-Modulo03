...
class VeiculoServiceTest {
    ...
    void inserir_sucesso() {
        ...
        Mockito.when(repo.save(Mockito.any(Veiculos.class))).thenReturn(veiculo);
    ...
    void listar_vazio() {
        List<Veiculos> resultado = service.listar();
    ...
    void obter() {
        Mockito.when(repo.findById(Mockito.anyString())).thenReturn(Optional.of(new Veiculos()));
